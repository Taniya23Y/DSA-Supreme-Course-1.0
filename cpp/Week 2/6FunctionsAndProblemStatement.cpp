...
int getGrade(int marks){
    switch (marks/10){
        case 10: return 'A'; break;   // explicility mentioned
...
#include <iostream>
using namespace std;
double ConvertCelsiusToFrahenheit( double Celsius){
      double frahenheit = Celsius * 9 / 5 + 32;       /* Convert C to F */
      return frahenheit;
}
int main(){
    double Celsius;
    ...
    cin >> Celsius;
    // function call
    double frahenheit  = ConvertCelsiusToFrahenheit(Celsius);
    cout << Celsius << " Degree Celsius is equal to: " << frahenheit << " degrees Fahrenheit." << endl;
   return 0;
}
